...
<div class="wrapper">
    <div class="sidebar">
		...
		<hr class="colorBlack">
        <ul>
            <a class="blackie" href="AdminLoginForm.php"><li class="twomodules">ADMIN</li></a>
            <a class="blackie" href="GuestLoginForm.php"><li class= "twomodules selected">GUEST</li></a>
        </ul> 
    </div>
    <div class="main_content">
		...
		<form>
			<table >
				...
				<tr>
					<td align="right">
						<input type="button" value="Sign In"> <input type="button" value="Sign Up">&nbsp;&nbsp;<br><br>
					</td>
				</td>
			</table>
			&nbsp;&nbsp;
